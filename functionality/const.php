<?php
    $GLOBALS["sign_in_url"] = "http://localhost/project/Perancangan-dan-Pemrograman-Web/login-register-user/login.php";
    $GLOBALS["sign_up_url"] = "http://localhost/project/Perancangan-dan-Pemrograman-Web/login-register-user/signup.php";
